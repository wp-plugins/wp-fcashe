...
/**
 ...
 Generated on 2015-05-04 */
abstract class Fcache_AdminPageFramework_Registry_Base {
    const VERSION = '3.5.6';
...
final class Fcache_AdminPageFramework_Registry extends Fcache_AdminPageFramework_Registry_Base {
    ...
    static public function setUp($sFilePath = __FILE__) {
        ...
        self::$sAutoLoaderPath = isset(self::$aClassFiles['Fcache_AdminPageFramework_RegisterClasses']) ? self::$aClassFiles['Fcache_AdminPageFramework_RegisterClasses'] : '';
        self::$bIsMinifiedVersion = class_exists('Fcache_AdminPageFramework_MinifiedVersionHeader');
    }
...
final class Fcache_AdminPageFramework_Bootstrap {
    public function __construct($sLibraryPath = __FILE__) {
        if (!$this->_isLoadable()) {
            return;
        }
        Fcache_AdminPageFramework_Registry::setUp($sLibraryPath);
        if (Fcache_AdminPageFramework_Registry::$bIsMinifiedVersion) {
            return;
        }
        include (Fcache_AdminPageFramework_Registry::$sAutoLoaderPath);
        new Fcache_AdminPageFramework_RegisterClasses(empty(Fcache_AdminPageFramework_Registry::$aClassFiles) ? Fcache_AdminPageFramework_Registry::$sDirPath : '', array('exclude_class_names' => array('Fcache_AdminPageFramework_MinifiedVersionHeader', 'Fcache_AdminPageFramework_BeautifiedVersionHeader',),), Fcache_AdminPageFramework_Registry::$aClassFiles);
        Fcache_AdminPageFramework_Registry::$bIsDevelopmentVersion = class_exists('Fcache_AdminPageFramework_InclusionClassFilesHeader');
    }
...
new Fcache_AdminPageFramework_Bootstrap(__FILE__);