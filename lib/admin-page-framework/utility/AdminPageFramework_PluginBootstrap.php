 ...
 */
abstract class Fcache_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('Fcache_AdminPageFramework_RegisterClasses')) {
            return;
        }
        new Fcache_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
