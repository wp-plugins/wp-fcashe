 ...
 */
abstract class Fcache_AdminPageFramework_Page_View extends Fcache_AdminPageFramework_Page_View_MetaBox {
    ...
    private function _getFormOutput($sPageSlug) {
        ...
        $_oFieldsTable = new Fcache_AdminPageFramework_FormTable($this->oProp->aFieldTypeDefinitions, $this->aFieldErrors, $this->oMsg);
