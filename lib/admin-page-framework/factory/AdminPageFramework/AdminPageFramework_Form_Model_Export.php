 ...
 */
abstract class Fcache_AdminPageFramework_Form_Model_Export extends Fcache_AdminPageFramework_Form_Model_Import {
    protected function _exportOptions($mData, $sPageSlug, $sTabSlug) {
        $_oExport = new Fcache_AdminPageFramework_ExportOptions($_POST['__export'], $this->oProp->sClassName);
