 ...
 */
abstract class Fcache_AdminPageFramework_Form_Model_Import extends Fcache_AdminPageFramework_Router {
    protected function _importOptions($aStoredOptions, $sPageSlug, $sTabSlug) {
        $_oImport = new Fcache_AdminPageFramework_ImportOptions($_FILES['__import'], $_POST['__import']);
