 ...
 */
abstract class Fcache_AdminPageFramework_Page_View_MetaBox extends Fcache_AdminPageFramework_Page_Model {
    ...
    private function _isMetaBoxAdded($sPageSlug = '') {
        if (!isset($GLOBALS['aFcache_AdminPageFramework']['aMetaBoxForPagesClasses']) || !is_array($GLOBALS['aFcache_AdminPageFramework']['aMetaBoxForPagesClasses'])) {
            return false;
        }
        ...
        foreach ($GLOBALS['aFcache_AdminPageFramework']['aMetaBoxForPagesClasses'] as $sClassName => $oMetaBox) {
    ...
    public function _replyToAddMetaboxScript() {
        if (isset($GLOBALS['aFcache_AdminPageFramework']['bAddedMetaBoxScript']) && $GLOBALS['aFcache_AdminPageFramework']['bAddedMetaBoxScript']) {
            return;
        }
        $GLOBALS['aFcache_AdminPageFramework']['bAddedMetaBoxScript'] = true;
