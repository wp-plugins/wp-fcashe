 ...
 */
abstract class Fcache_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sFieldsType) {
        ...
        $GLOBALS['aFcache_AdminPageFramework'] = isset($GLOBALS['aFcache_AdminPageFramework']) && is_array($GLOBALS['aFcache_AdminPageFramework']) ? $GLOBALS['aFcache_AdminPageFramework'] : array('aFieldFlags' => array());
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => Fcache_AdminPageFramework_Registry::NAME, 'sURI' => Fcache_AdminPageFramework_Registry::URI, 'sScriptName' => Fcache_AdminPageFramework_Registry::NAME, 'sLibraryName' => Fcache_AdminPageFramework_Registry::NAME, 'sLibraryURI' => Fcache_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => Fcache_AdminPageFramework_Registry::getVersion(), 'sDescription' => Fcache_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => Fcache_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => Fcache_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => Fcache_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => Fcache_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        if ('aScriptInfo' === $sName) {
            $this->sCallerPath = $this->sCallerPath ? $this->sCallerPath : Fcache_AdminPageFramework_Utility::getCallerScriptPath(__FILE__);
