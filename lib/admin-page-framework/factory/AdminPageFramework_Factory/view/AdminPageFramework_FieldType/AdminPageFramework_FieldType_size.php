 ...
 */
class Fcache_AdminPageFramework_FieldType_size extends Fcache_AdminPageFramework_FieldType_select {
...
CSSRULES;
    ...
    private function _getUnitInputObject(array $aField, array $aUnitAttributes) {
        ...
        return new Fcache_AdminPageFramework_Input_select($_aUnitField);
    }
