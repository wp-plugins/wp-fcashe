 ...
 */
class Fcache_AdminPageFramework_FieldType_system extends Fcache_AdminPageFramework_FieldType {
...
CSSRULES;
    ...
    private function _getPHPInfo($bGenerateInfo = true) {
        ...
        $_oErrorReporting = new Fcache_AdminPageFramework_ErrorReporting;
