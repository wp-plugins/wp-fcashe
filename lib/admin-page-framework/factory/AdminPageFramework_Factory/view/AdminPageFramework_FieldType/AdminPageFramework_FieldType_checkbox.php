 ...
 */
class Fcache_AdminPageFramework_FieldType_checkbox extends Fcache_AdminPageFramework_FieldType {
...
CSSRULES;
    ...
    private function _getEachCheckboxOutput(array $aField, $sKey, $sLabel) {
        $_oCheckbox = new Fcache_AdminPageFramework_Input_checkbox($aField['attributes']);
