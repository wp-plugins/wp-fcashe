 ...
 */
class Fcache_AdminPageFramework_FieldType_taxonomy extends Fcache_AdminPageFramework_FieldType_checkbox {
    ...
    protected function setUp() {
        new Fcache_AdminPageFramework_Script_CheckboxSelector;
    }
