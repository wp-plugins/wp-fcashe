 ...
 */
class Fcache_AdminPageFramework_FieldType_radio extends Fcache_AdminPageFramework_FieldType {
...
JAVASCRIPTS;
    ...
    private function _getEachRadioButtonOutput(array $aField, $sKey, $sLabel) {
        $_oRadio = new Fcache_AdminPageFramework_Input_radio($aField['attributes']);
