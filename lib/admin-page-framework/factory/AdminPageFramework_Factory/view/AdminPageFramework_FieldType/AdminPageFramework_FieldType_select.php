 ...
 */
class Fcache_AdminPageFramework_FieldType_select extends Fcache_AdminPageFramework_FieldType {
...
CSSRULES;
    ...
    protected function getField($aField) {
        $_oSelectInput = new Fcache_AdminPageFramework_Input_select($aField['attributes']);
