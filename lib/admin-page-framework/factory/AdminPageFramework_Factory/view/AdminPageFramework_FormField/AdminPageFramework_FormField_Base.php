 ...
 */
abstract class Fcache_AdminPageFramework_FormField_Base extends Fcache_AdminPageFramework_FormOutput {
    public $aField = array();
    ...
    private function _loadScripts($sFieldsType = '') {
        if ('widget' === $sFieldsType && !self::$_bIsLoadedSScripts_Widget) {
            new Fcache_AdminPageFramework_Script_Widget;
        ...
        new Fcache_AdminPageFramework_Script_Utility;
        new Fcache_AdminPageFramework_Script_OptionStorage;
        new Fcache_AdminPageFramework_Script_AttributeUpdator;
        new Fcache_AdminPageFramework_Script_RepeatableField($this->oMsg);
        new Fcache_AdminPageFramework_Script_Sortable;
        new Fcache_AdminPageFramework_Script_RegisterCallback;
    }
